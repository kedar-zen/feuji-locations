import svgPaths from "./svg-v0p0k1c5n1";
...
function Address() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full" data-name="Address">
      <LocationOn />
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[24px] min-w-px not-italic relative text-[16px] text-black">Feuji Costa Rica S.R.L. Ultrapark 1 Free Zone, Building 7B, La Aurora de Heredia, Costa Rica</p>
    </div>
  );
}
...
function Email() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full" data-name="Email">
      <AlternateEmail />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[16px] text-black whitespace-nowrap">info.costarica@feuji.com</p>
    </div>
  );
}
...
export default function San() {
  return (
    <div className="content-stretch flex flex-col items-stretch relative size-full" data-name="SAN">
      <Details />
    </div>
  );
}