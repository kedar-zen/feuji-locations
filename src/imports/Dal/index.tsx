import svgPaths from "./svg-ws14ysr2c6";
...
function Details() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] items-start p-[24px] relative rounded-[24px] shrink-0 w-full" data-name="Details">
      <p className="[word-break:break-word] font-['Cabinet_Grotesk_Variable:Medium',sans-serif] font-medium leading-[29px] relative shrink-0 text-[#0b1f3a] text-[24px] tracking-[-1px] w-full">Dallas, Texas, USA</p>
      <Info />
    </div>
  );
}
...
export default function Dal() {
  return (
    <div className="content-stretch flex flex-col items-stretch relative size-full" data-name="DAL">
      <Details />
    </div>
  );
}